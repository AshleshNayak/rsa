...
Its security relies on the practical difficulty of factoring the product of two very small prime numbers. This demo shows what happens when that principle is ignored by using tiny, 2-digit primes.
